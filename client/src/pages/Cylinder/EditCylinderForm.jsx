...
import { updateCylinder } from '../../redux/actions/cylinder';

export const EditCylinderForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(updateCylinder(cylinder._id, data))
    }
    return (
        <Wrapper>
            <Title>Изменение цилиндра</Title>
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <InputText
                            ...
                            defaultValue={cylinder.originalName}
                        />
