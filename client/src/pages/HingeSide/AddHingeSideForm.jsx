...
import { addHingeSide } from '../../redux/actions/hinge-side';

export const AddHingeSideForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(addHingeSide(data))
    }
    return (
        <Wrapper>
            <Title>Добавление новой сторонности петель</Title>
