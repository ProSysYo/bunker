...
export const EditTypeCanvasForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()        
        dispatch(updateTypeCanvas(typeCanvas._id, data))
    }
    return (
        <Wrapper>
            <Title>Изменение типа полотна</Title>
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <InputText
                            ...
                            defaultValue={typeCanvas.description}
                        />
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <Select
                            ...
                            defaultValue={typeCanvas.trimOutside}                       
                        >
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <Select
                            ...
                            defaultValue={typeCanvas.trimInside}                        
                        >
                            <option disabled value=""> --выберите из списка-- </option>                            
                            <option value="металл">металл</option>
                            <option value="панель">панель</option>
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <Select
                            ...
                            defaultValue={typeCanvas.insulation}                        
                        >
                            <option disabled value=""> --выберите из списка-- </option>                            
