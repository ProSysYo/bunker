...
import { AddWrapForm } from './AddWrapForm';
import { EditWrapContainer } from './EditWrapContainer';

import { deleteWrap, getWraps } from '../../redux/actions/wrap';
...
export const Wraps = () => {
    ...
    const submitSuccess = useSelector(state => state.wrap.submitSuccess)
