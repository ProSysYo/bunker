...
import { updatePartisanship } from '../../redux/actions/partisanship';

export const EditPartisanshipForm = () => {
    const { register, handleSubmit, setError, formState: { errors } } = useForm()

    const dispatch = useDispatch()

    const errorsValidate = useSelector(state => state.partisanship.errors)
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(updatePartisanship(partisanship._id, data))
    }
    return (
        <Wrapper>
            <Title>Изменение партийности</Title>
                ...
                <FormItem>
                    ...
                    <FormItemInput>
                        <InputText
                            ...
                            defaultValue={partisanship.name}
                        />
