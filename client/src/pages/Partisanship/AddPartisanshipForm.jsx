...
import { addPartisanship } from '../../redux/actions/partisanship';

export const AddPartisanshipForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(addPartisanship(data))
    }
    return (
        <Wrapper>
            <Title>Добавление новой партийности</Title>
