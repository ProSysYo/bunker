...
import { addPeepholeLocation } from '../../redux/actions/peephole-location';

export const AddPeepholeLocationForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(addPeepholeLocation(data))
    }
    return (
        <Wrapper>
            <Title>Добавление нового расположения цилиндра</Title>
