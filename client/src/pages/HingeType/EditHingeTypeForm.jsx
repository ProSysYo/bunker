...
import { updateHingeType } from '../../redux/actions/hinge-type';

export const EditHingeTypeForm = () => {
    ...
    const onSubmit = (data, e) => {
        e.preventDefault()
        dispatch(updateHingeType(hingeType._id, data))
    }
    return (
        <Wrapper>
            <Title>Изменение типа петель</Title>
